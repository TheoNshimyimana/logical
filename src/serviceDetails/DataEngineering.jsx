      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-700 mb-10 text-xl leading-10">
            <strong>Cleaning and Sanitizing:</strong> Cleaning condenser coils,
            evaporator coils, and fan blades to prevent build-up and ensure
            efficient cooling. <br />
            <strong>Refrigerant Level Check and Recharge:</strong>
            Monitoring refrigerant levels and recharging the gas if levels are
            low to maintain optimal cooling performance. <br />{" "}
            <strong>Compressor and Condenser Repair:</strong> Diagnosing issues
            with the compressor and condenser, and performing repairs or
            replacements if needed. <br />
            <strong>Electrical and Control System Repairs:</strong> Repairing or
            replacing faulty electrical components and control systems to ensure
